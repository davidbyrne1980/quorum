...
> **Supersedes v1.** v1 was `provisional-open-questions`. The four clarifiable levers were put to the Product Manager at scoring; all were confirmed at their defaults (ARR Growth = keep pilot override; ARR Retain = 0; EBITDAC = 0; Table Stakes = No). Total Score is unchanged at **72.5** — the change is confidence, not value.
>
...
3-pass consistency check completed. Confidence: **High**. All clarifiable financial levers were confirmed with the Product Manager; remaining defaults rest on ticket evidence, not missing data.
...
ARR Growth: 20 (10 × 2) — No ARR £ figure; Product Manager confirmed at scoring to keep the named EoE Coop / M&S pilot override (base 10, ×2 = 20).
ARR Retain: 0 (0 × 2) — Product Manager confirmed no existing ARR is at risk if not built.
...
EBITDAC: 0 — Product Manager confirmed no RI operational saving (the $200M is client sales benefit, not RI cost).
Table Stakes: 0 (0 × 2) — Product Manager confirmed this is a differentiator, not a baseline requirement clients demand.
...
- Table Stakes = (blank; confirmed No by Product Manager)
...
- ARR £ / EBITDAC £ = not present; confirmed with Product Manager (ARR via pilot override, EBITDAC 0)

**Product Manager clarifications (manual run):**
...
## Score Explanation
Named EoE Coop/M&S pilot with a strong USP vs Quorso lifts ARR-growth and competitive levers, but a ~92-day DS-heavy new-platform build zeros Time/Effort/Complexity. ARR/EBITDAC/Table-Stakes confirmed at default by Product Manager. Net: high strategic pull, heavy delivery cost.

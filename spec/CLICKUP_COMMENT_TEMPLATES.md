...
- `[OPTIONS]` — decision options presented to Product Manager
...
**Note:** This comment is internal — tagged at Product Manager. The submitter has not yet been asked anything.
...
### T-05 — Day 6 Chase + Product Manager Flag
...
### T-07 — Demand Signal Summary (after Product Manager review)

**When posted:** After the Product Manager approves the filtered demand signal write-back at Gate 2. Never posted at gate-open — pre-approval, output lives in Supabase/chat only.
...
**When posted:** After CoE Pass 1 completes — presenting result for Product Manager decision.
...
### T-11 — CoE Pass 2 Summary (after Product Manager review)
...
**When posted:** After Requirements Agent completes — presenting for Product Manager soft review.
...
### T-13 — Requirements Summary (after Product Manager approval)
...
**When posted:** Orchestrator has identified BAU/CR signal — confirming with Product Manager.
**Tags added:** `human-review-required`
...
**When posted:** All upstream stages complete — presenting for final Product Manager approval.
...
**Reason for closure:** [CONTENT: one of — No submitter response (9 working days) / Rejected at [stage] / Confirmed duplicate of [ticket ID] / Merged into [ticket ID] / Insufficient demand evidence / Product Manager decision]
